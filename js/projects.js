...
document.addEventListener('DOMContentLoaded', function() {
    ...
    let projects = JSON.parse(localStorage.getItem('projects')) || [
        ...
        },
        {
            ...
            description: 'A machine learning model that analyzes customer reviews to determine sentiment and extract key insights for product improvement.',
            category: 'nlp',
            technologies: 'BERT, PyTorch, Hugging Face, Python',
            github: 'https://github.com/bobjohnson/sentiment-analysis',
        ...
        },
        {
            ...
            description: 'A computer vision system that detects and classifies objects in real-time for autonomous vehicle navigation and obstacle avoidance.',
            category: 'cv',
            technologies: 'YOLO, OpenCV, TensorFlow, Python',
            github: 'https://github.com/carolwilliams/object-detection',
            demo: 'https://object-detection-demo.example.com',
        ...
        },
        {
            ...
            description: 'An AI agent trained using reinforcement learning to play and master classic Atari games with superhuman performance.',
            category: 'rl',
            technologies: 'PyTorch, OpenAI Gym, Python',
            github: 'https://github.com/davidmiller/rl-game-ai',
            demo: 'https://rl-game-demo.example.com',
            image: 'rl-game.jpg',
            author: {
                name: 'David Miller',
                avatar: 'DM'
        ...
        },
        {
            ...
            description: 'A machine learning system that predicts equipment failures before they occur, reducing downtime and maintenance costs for industrial machinery.',
            category: 'ml',
            technologies: 'Scikit-learn, XGBoost, Pandas, Python',
            github: 'https://github.com/emilyjones/predictive-maintenance',
            demo: 'https://predictive-maintenance-demo.example.com',
        ...
        {
            id: 6,
            title: 'Generative Adversarial Network for Art Creation',
            description: 'A GAN model that generates original artwork in various styles, trained on a dataset of famous paintings from different art movements.',
            category: 'dl',
            technologies: 'TensorFlow, GANs, Python',
            github: 'https://github.com/franklee/gan-art',
            demo: 'https://gan-art-demo.example.com',
            image: 'gan-art.jpg',
            author: {
                name: 'Frank Lee',
                avatar: 'FL'
